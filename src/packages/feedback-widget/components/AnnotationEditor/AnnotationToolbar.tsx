...
import { ANNOTATION_COLORS, FONT_SIZES, type AnnotationTool, type FontSize } from "../../types/annotations";
...
export default function AnnotationToolbar() {
  ...
  return (
    <div className="flex items-center gap-1 p-2 bg-card border border-border rounded-lg shadow-sm flex-wrap">
      {/* Tools */}
